...
const styles = StyleSheet.create({
  ...
  input: { height: 52, borderWidth: 1, borderColor: colors.line, borderRadius: 12, paddingHorizontal: 16, fontSize: 17, backgroundColor: "#fff", color: colors.ink, fontWeight: "600" },
